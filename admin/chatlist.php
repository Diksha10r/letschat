...
<div class="col-lg-12">
    <div class="panel panel-default" style="height:50px;">
		...
		<div class="pull-right" style="margin-right:10px; margin-top:7px;">
			<a href="#add_chatroom" data-toggle="modal" class="btn btn-primary but"><span class="glyphicon glyphicon-plus"></span> Add</a>
		</div>
	</div>
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
		...
		<?php
			...
			<tr>
				...
				<td><a href="chatroom.php?id=<?php echo $row['chatroomid']; ?>" class="btn btn-info b1"><span class="glyphicon glyphicon-comment"></span> Join</a> || 
					<button class="btn btn-warning edit b2" value="<?php echo $row['chatroomid']; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</button> || 
					<button class="btn btn-danger delete b3" value="<?php echo $row['chatroomid']; ?>"><span class="glyphicon glyphicon-trash"></span> Delete</button>
				</td>
			</tr>
			<?php
			}
