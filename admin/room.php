...
<div class="col-lg-12">
            <div class="panel panel-default" style="height:50px;">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					...
					<a href="index.php" class="btn btn-primary b2"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
				</div>
			...
			<div>
				...
				<div class="input-group">
					...
					<button class="btn btn-success b1" type="submit" id="send_msg" value="<?php echo $id; ?>">
